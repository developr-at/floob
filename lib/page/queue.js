...
var PageQueue = {
    ...
    create: function create(options) {
        ...
        var queue = {
             ...
             */
            isExcluded: function isExcluded(url) {
            ...
            enqueue: function enqueue(url) {
                ...
                if (queue.isExcluded(url)) {
                    _appLogger2.default.verbose('PageQueue', 'Ignore excluded url: ' + url);
                    return false;
                }
        ...
        function setup(setupOptions) {
            ...
            var appConfig = setupOptions.appConfig;
            ...
            pageFetcher = _fetcher2.default.create();
        ...
        function processNext() {
            ...
            pageFetcher.fetch(url, function (pageResult) {
                ...
                if (config.limit && processedUrls.length >= config.limit) {
                    _appLogger2.default.info('PageQueue', 'Reached the page limit of ' + config.limit + ' pages!');
                    return finishedFn();
                }
