...
var FloobApp = {
    ...
    setup: function setup(options) {
        ...
        appConfig = (0, _extend2.default)({}, DefaultAppConfig, config.options);
    ...
    process: function process(options) {
        ...
        this.queue = _queue2.default.create({ url: url, appConfig: appConfig, start: function start(queue) {
                _pluginManager2.default.start(queue, self.logger);
            }, processResult: function processResult(data) {
